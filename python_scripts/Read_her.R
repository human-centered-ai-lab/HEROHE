...
for (i in 1:length(tests[,2])){
  ...
  slide_vals = cbind(slide_vals, length(herohe_data_xl_neg[herohe_data_xl_neg$filename == tests:pos[, 2][i],]$nucleus_area))
  slide_vals = cbind(slide_vals, length(herohe_data_l_neg[herohe_data_l_neg$filename == tests_pos[, 2][i],]$nucleus_area))
  slide_vals = cbind(slide_vals, length(herohe_data_m_neg[herohe_data_m_neg$filename == tests_pos[, 2][i],]$nucleus_area))
  slide_vals = cbind(slide_vals, length(herohe_data_s_neg[herohe_data_s_neg$filename == tests_pos[, 2][i],]$nucleus_area))
  slide_vals = slide_vals/sum(slide_vals)
  slide_names_neg = cbind(slide_names_neg[,2][i], slide_names_neg)

  slide_vals = cbind(slide_vals, mean(herohe_data_xl_neg[herohe_data_xl_neg$filename == tests_pos[, 2][i],]$nucleus_circularity))
  slide_vals = cbind(slide_vals, mean(herohe_data_l_neg[herohe_data_l_neg$filename == tests_pos[, 2][i],]$nucleus_circularity))
  slide_vals = cbind(slide_vals, mean(herohe_data_m_neg[herohe_data_m_neg$filename == tests_pos[, 2][i],]$nucleus_circularity))
  slide_vals = cbind(slide_vals, mean(herohe_data_s_neg[herohe_data_s_neg$filename == tests_pos[, 2][i],]$nucleus_circularity))
  
  slide_vals = cbind(slide_vals, mean(herohe_data_xl_neg[herohe_data_xl_neg$filename == tests_pos[, 2][i],]$nucleus_perimeter))
  slide_vals = cbind(slide_vals, mean(herohe_data_l_neg[herohe_data_l_neg$filename == tests_pos[, 2][i],]$nucleus_perimeter))
  slide_vals = cbind(slide_vals, mean(herohe_data_m_neg[herohe_data_m_neg$filename == tests_pos[, 2][i],]$nucleus_perimeter))
  slide_vals = cbind(slide_vals, mean(herohe_data_s_neg[herohe_data_s_neg$filename == tests_pos[, 2][i],]$nucleus_perimeter))

  slide_mat_neg = rbind(slide_mat_neg, slide_vals)
  print(i)
  print(length(tests[, 2]))
}
slide_mat_pos = c()
class_vec_pos = c()
...
for(i in 1:length(tests_neg[, 2])){
  ...
  slide_vals = cbind(slide_vals, length(herohe_data_xl_pos[herohe_data_xl_pos$filename == tests_neg[, 2][i],]$nucleus_area))
  slide_vals = cbind(slide_vals, length(herohe_data_l_pos[herohe_data_l_pos$filename == tests_neg[, 2][i],]$nucleus_area))
  slide_vals = cbind(slide_vals, length(herohe_data_m_pos[herohe_data_m_pos$filename == tests_neg[, 2][i],]$nucleus_area))
  slide_vals = cbind(slide_vals, length(herohe_data_s_pos[herohe_data_s_pos$filename == tests_neg[, 2][i],]$nucleus_area))

  slide_vals = slide_vals/sum(slide_vals)
  slide_names_pos = cbind(slide_names_pos[,2][i], slide_names_pos)
  
  slide_vals = cbind(slide_vals, mean(herohe_data_xl_pos[herohe_data_xl_pos$filename == tests_neg[, 2][i],]$nucleus_circularity))
  slide_vals = cbind(slide_vals, mean(herohe_data_l_pos[herohe_data_l_pos$filename == tests_neg[, 2][i],]$nucleus_circularity))
  slide_vals = cbind(slide_vals, mean(herohe_data_m_pos[herohe_data_m_pos$filename == tests_neg[, 2][i],]$nucleus_circularity))
  slide_vals = cbind(slide_vals, mean(herohe_data_s_pos[herohe_data_s_pos$filename == tests_neg[, 2][i],]$nucleus_circularity))

  
  slide_vals = cbind(slide_vals, mean(herohe_data_xl_pos[herohe_data_xl_pos$filename == tests_neg[, 2][i],]$nucleus_perimeter))
  slide_vals = cbind(slide_vals, mean(herohe_data_l_pos[herohe_data_l_pos$filename == tests_neg[, 2][i],]$nucleus_perimeter))
  slide_vals = cbind(slide_vals, mean(herohe_data_m_pos[herohe_data_m_pos$filename == tests_neg[, 2][i],]$nucleus_perimeter))
  slide_vals = cbind(slide_vals, mean(herohe_data_s_pos[herohe_data_s_pos$filename == tests_neg[, 2][i],]$nucleus_perimeter))

  slide_mat_pos = rbind(slide_mat_pos, slide_vals)
  print(i)
  print(length(tests[, 6]))
} 
